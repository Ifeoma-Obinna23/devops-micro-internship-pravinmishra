...
![alt text](screenshots/Project-sidebar-after-creation-ass4.png)
...
Dev Lead: Responsible for what gets built — the actual implementation of the chosen UI Story.
...
![alt text](screenshots/Project-created-page-showing-ass4.png)
...
![alt text](screenshots/Backlog-showing-Epic-panel-ass4.png)
...
![alt text](screenshots/Backlog-showing-Epic-Stories-ass4.png)

---

#### Screenshot 5 — One Story opened showing its Story Points and acceptance criteria filled in

![alt text](screenshots/One-Story-opened-showing-Story-Points-ass4.png)
...
![alt text](screenshots/Backlog-showing-Story-Points-visible-ass4.png)
...
S6 – Search labels (2 points): Several labels and placeholders need to be updated and tested, so it requires more work than a single text change.
...
![alt text](screenshots/Sprint1-with-selected-Stories-inside-ass4.png)

---

#### Screenshot 8 — One Story showing the Sub-tasks created

![alt text](screenshots/One-Story-showing-Subtasks-created-ass4.png)
...
![alt text](screenshots/Burndown-chart-page-opened-ass4.png)
...
![alt text](screenshots/Jira-board-showing-story-moved-to-done-ass4.png)

---

#### Screenshot 11 — Git commit output
![alt text](screenshots/git-commit-ass4.png)


---

#### Screenshot 12 — Live URL in the browser showing the UI change, with the URL visible
![alt text](screenshots/Live-URL-showing-ass4.png)
...
![alt text](screenshots/Jira-retro-comment-visible-ass4.png)
...
#### LinkedIn Post URL
https://www.linkedin.com/posts/ifeoma-akabueze_agile-jira-agenticai-ugcPost-7492359869149302784-6rjj/

---

#### Screenshot 14 — Published LinkedIn post

![alt text](screenshots/Published-LinkedIn-post-ass4.png)
