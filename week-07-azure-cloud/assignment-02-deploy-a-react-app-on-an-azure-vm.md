...
![alt text](screenshots/Resource-Group-overview-showing-the-name-and-region-ass2.png)
...
![alt text](screenshots/Azure-VM-overview-page-showing-the-VM-name-RG-and-region-ass2.png)

---

#### Screenshot 3 — Network Security Group inbound rules showing ports 22 and 80 allowed

![alt text](screenshots/Network-SG-inboun-rules-showing-ports-22-and-80-allowed-ass2.png)
...
![alt text](screenshots/Terminal-showing-a-successful-SSH-login-ass2.png)
...
![alt text](screenshots/Terminal-output-showing-node-v-and-npm-v-ass2.png)
...
![alt text](screenshots/Terminal-showing-successful-npm-run-build-completion-and-ls-la-build-output-ass2.png)
...
![alt text](screenshots/Successful-sudo-nginx-t-output-ass2.png)

---

#### Screenshot 8 — Nginx configuration snippet showing the build root and `try_files` directive

![alt text](screenshots/Nginx-configuration-snippet-showing-the-build-root-and-try-files-directive-ass2.png)
...
![alt text](screenshots/Browser-showing-the-React-app-with-the-public-IP-visible-in-the-address-bar-ass2.png)
...
![alt text](screenshots/Network-SG-rule-showing-SSH-restricted-to-your-IP-ass2.png)
