...
![alt text](screenshots/forked-repo-visible-inbrowser-url-ass5.png)
...
![alt text](<screenshots/git-config -global-get-cred-ass5.png>)
...
![alt text](screenshots/git-remote-v-ass5.png)
...
![alt text](screenshots/git-status-showing-pullreq-modified-ass5.png)

---

#### Screenshot 5 — Output of `git commit`

![alt text](screenshots/git-commit-docs-added-my-name-ass5.png)
...
![alt text](screenshots/base-branch-head-repo-ass5.png)

---

#### Screenshot 9 — Successfully created Pull Request page with the PR number visible

![alt text](screenshots/successfully-created-PR-ass5.png)
...
https://www.linkedin.com/posts/ifeoma-akabueze_dmibypravinmishra-agenticai-claudecode-ugcPost-7486229319871049728-iPFP/?
