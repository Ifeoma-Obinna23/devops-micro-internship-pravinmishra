...
![alt text](screenshots/pwd-git-ass2.png)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![alt text](screenshots/git-status-ass2.png)
...
![alt text](screenshots/git-ls-index-html-ass2.png)
...
![alt text](screenshots/git-index-html-ass2.png)
![alt text](screenshots/git-style-css-ass2.png)
...
![alt text](screenshots/git-status-untracked-ass2.png)

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![alt text](<screenshots/git-status-changes-to be committed-ass2.png>)
...
![alt text](screenshots/git-commit-m-ass2.png)
---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![alt text](screenshots/git-log-online-ass2.png)
...
![alt text](screenshots/browser-showing-updated-ass2.png)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![alt text](screenshots/git-index-modified-ass2.png)

---

#### Screenshot 11 — Output of `git commit`

![alt text](screenshots/git-commit-m-update-ass2.png)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![alt text](screenshots/git-log-online-after-commit-ass2.png)
...
![alt text](screenshots/nginx-active-git-ass2.png)

---

#### Screenshot 14 — Output of `curl -I http://localhost` showing `HTTP/1.1 200 OK`

![alt text](screenshots/curl-l-200-OK-git-ass2.png)

---

#### Screenshot 15 — Browser showing the CodeTrack site loaded at `http://<EC2_PUBLIC_IP>`, with your Full Name and Group Name visible

![alt text](screenshots/browser-showing-codetrack-git-ass2.png)
...
https://www.linkedin.com/posts/ifeoma-akabueze_dmibypravinmishra-agenticai-claudecode-share-7485199281507897345-tQzG/?

---

#### Screenshot — LinkedIn post showing the deployed CodeTrack application

![alt text](screenshots/LinkedIn-screenshot-ass2.png)
