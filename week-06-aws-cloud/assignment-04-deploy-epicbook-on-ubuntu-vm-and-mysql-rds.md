...
![alt text](screenshots/VPC-details-showing-CIDR-ass4.png)

---

#### Screenshot 2 — Subnets list showing both subnets and their CIDRs

![alt text](screenshots/Subnets-list-showing-both-subnets-ass4.png)

---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![alt text](screenshots/Route-table-showing-IGW-and-association-ass4.png)
...
![alt text](screenshots/EC2-sg-inbound-rules-showing-ports-and-sources-ass4.png)

---

#### Screenshot 5 — RDS security-group inbound rule showing MySQL 3306 allowed from the EC2 security group

![alt text](screenshots/RDS-sg-inbound-rule-showing-ass4.png)
...
![alt text](screenshots/EC2-instance-summary-ass4.png)

---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![alt text](screenshots/Terminal-showing-successful-SSH-login.png)
...
![alt text](screenshots/node-version-ass4.png)
![alt text](screenshots/npm-version-ass4.png)
---

#### Screenshot 9 — Output of `systemctl status nginx`
![alt text](screenshots/systemctl-status-nginx-ass4.png)
...
![alt text](screenshots/mysql--version-ass4.png)
...
![alt text](screenshots/RDS-instance-summary-showing-ass4.png)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![alt text](screenshots/Connectivity-and-security-section-showing-theVPC-attached-ass4.png)
...
![alt text](screenshots/Terminal-showing-successful-SHOWTABLES-ass4.png)
...
![alt text](screenshots/Terminal-showing-repository-cloned-and-ls-output-ass4.png)

---

#### Screenshot 15 — Terminal showing the backend running, or `ss -tulpn` showing the port open

![alt text](screenshots/Terminal-showing-backend-running-ss-tulpn-ass4.png)

---

#### Screenshot 16 — `curl` output proving the backend responds; a 200, 301, or 404 response is acceptable if the service responds

![alt text](screenshots/curl-output-proving-backend-responds-ass4.png)
...
![alt text](screenshots/nginx-t-success-output-ass4.png)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![alt text](screenshots/Nginx-configuration-snippet-showing-the-api-reverse-proxy-ass4.png)
...
![alt text](screenshots/Browser-showing-EpicBook-application-with-pubIP-ass4.png)

---

#### Screenshot 20 — Terminal showing a successful API call through the public endpoint, such as `curl http://<EC2_PUBLIC_IP>/api/...`
![alt text](screenshots/Terminal-showing-successful-API-call-through-public-endpoint-ass4.png)

---

#### Screenshot 21 — Terminal showing the successful database connectivity test using `SELECT 1;` or similar

![alt text](screenshots/Terminal-showing-successful-database-connectivity-test-using-SELECT-1-ass4.png)
